...
%Goal
The goal of this thesis is to design and implement an XMPP-Grid broker to configure existing controllers (XMPP servers), focussing on portability, extensibility and the aspects of security in a production environment.
The broker application should enable administrators to configure XMPP-Grids in a usable and productive way.\\
\vspace*{1ex}

%Result
Our proposed architecture earmarks a purely client-side web application that communicates with the controller via WebSockets or HTTP streams (BOSH).
