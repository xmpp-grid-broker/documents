...
To exchange security-relevant information between network endpoints over a XMPP-Grid, the IETF Managed Incident Lightweight Exchange~(MILE) working group proposes to standardise ``Using XMPP for Security Information Exchange''.\\
\vspace*{1ex}

The configuration and maintenance of a XMPP-Grid is described in the standard as a Broker application.

Today, no production ready implementations of a XMPP-Grid Broker exists.\\
\vspace*{1ex}

In this thesis we propose and implement a Broker management web application based on the Angular framework. It permits administrators to create and configure communication Topics, apprehend the underlying hierarchy and access permissions. Additionally, persistent items of Topics can be inspected and published.

The implementation and documentation lies a strong focus on portability, extensibility and security aspects of the application in a production environment.\\
\vspace*{1ex}
