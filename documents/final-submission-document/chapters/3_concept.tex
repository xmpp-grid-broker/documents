...
In this chapter, we present the architecture and architectural decisions of our application. All architectural decisions we took are documented fully in Appendix~\fullref{sec:architectural-decisions}.
...
A web application has the great advantage to be easily installable, upgradable and has minimal requirements on the user's side (i.e. only requires a web-browser to be executed).
