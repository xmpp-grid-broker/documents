...
\chapter{Analysis}
\epigraph{Without requirements or design, programming is the art of adding bugs to an empty text file.}{\textit{Louis Srygley}}
\section{Terminology}
...
In comparison to traditional tools for requirement analysis, user stories are more blured, levaing more space for changes. \cite{wirdemann2017scrum}
...
Detailed implementation prioritisation of the user stories are planned to be carried out before every sprint in agreement with Prof. Dr. Steffen.
