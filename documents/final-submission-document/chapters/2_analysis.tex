...
Figure~\ref{fig:architecturedslgriddraft} and \ref{fig:architecturedslxeps} present an overview of most interactions between the different components as specified in the XMPP grid draft~\cite{ietf-mile-xmpp-grid-05} and as used in the referenced XEPs (see Chapter~\ref{sec:technical-background}).
