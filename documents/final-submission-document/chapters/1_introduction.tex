...
Hereafter, we refer to \mdseries{this IETF standard draft} as \emph{\gls{xmpp} grid draft}.
...
As described in the \nameref{sec:task-description}, the focus of this thesis is on the evaluation, design and implementation of the XMPP Grid Broker.
